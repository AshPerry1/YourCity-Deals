-- YourCity Deals Complete Database Setup Script (Simplified)
...
CREATE POLICY "Allow all on coupon_books" ON coupon_books FOR ALL USING (true);
...
CREATE POLICY "Allow all on referral_links" ON referral_links FOR ALL USING (true);
CREATE POLICY "Allow all on referral_clicks" ON referral_clicks FOR ALL USING (true);
CREATE POLICY "Allow all on targeting_rules" ON targeting_rules FOR ALL USING (true);
CREATE POLICY "Allow all on coupon_grants" ON coupon_grants FOR ALL USING (true);
...
CREATE POLICY "Allow all on storage objects" ON storage.objects FOR ALL USING (true);
