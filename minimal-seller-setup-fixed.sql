-- Simple Seller Database Setup (Handles Existing Objects)
...
-- ========================================
-- TRIGGERS (WITH EXISTING OBJECT HANDLING)
-- ========================================
...
DROP TRIGGER IF EXISTS update_seller_invites_updated_at ON seller_invites;
...
DROP TRIGGER IF EXISTS update_organizational_hubs_updated_at ON organizational_hubs;
CREATE TRIGGER update_organizational_hubs_updated_at BEFORE UPDATE ON organizational_hubs
    FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_admin_coupon_books_updated_at ON admin_coupon_books;
