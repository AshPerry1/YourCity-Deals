...
const navigation = [
  ...
  { 
    ...
    description: 'Coupon book management'
  },
  { 
    name: 'Businesses', 
    href: '/admin/businesses', 
    icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
    description: 'Merchant partners'
  },
  { 
    name: 'Targeting', 
    href: '/admin/targeting', 
    icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z',
    description: 'Coupon targeting rules'
  },
  { 
    name: 'Analytics', 
  ...
  { 
    ...
    description: 'School payouts & receipts'
  },
  { 
    name: 'Settings', 
    href: '/admin/settings',
      ...
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h1 className="text-lg font-semibold text-gray-900">YourCity Deals</h1>
