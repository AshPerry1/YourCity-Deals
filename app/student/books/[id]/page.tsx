        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">{bookDetails.title}</h1>
                <p className="text-gray-600">{bookDetails.school}</p>
              </div>
            </div>
            <button
              ...
              className="bg-purple-600 text-white px-6 py-3 rounded-lg hover:bg-purple-700 transition-colors"
            >
              Purchase Book - {formatCurrency(bookDetails.price)}
            </button>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                {selectedOffer.redemptionCode && (
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <h3 className="font-semibold text-gray-900 mb-2">Redemption Code</h3>
                    <p className="font-mono text-lg text-gray-900">{selectedOffer.redemptionCode}</p>
                    <p className="text-sm text-gray-600 mt-1">Show this code to the merchant when redeeming</p>
                  </div>
                )}
              </div>
              ...
              <div className="mt-6 flex space-x-4">
                ...
                >
                  Purchase Book to Use This Offer
                </button>
              </div>
            </div>
          </div>
